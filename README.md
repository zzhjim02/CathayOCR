...
> ⚠️ **如果你已经下载了 v1.0.0 版本并发现以下问题，请一定更新到 v1.1.3：**
>
> 🐛 **PDF 导出缺字/识字不全** — 中文、日文、韩文等字符在导出的 PDF 中"消失"了？已修复 ✅
> 🐛 **启动闪退/打不开** — 双击图标闪一下就关闭？已修复 ✅
>
> ⬇️ [点击这里直接下载 v1.1.3](https://github.com/zzhjim02/CathayOCR/releases/tag/v1.1.3)（保留旧版本下载链接，放心下载）
---
## 🔗 Cathay 人文研究工具链
...
| 步骤 | 工具 | 功能 | 状态 |
|:----:|:----|:----|:----:|
| ① | **⭐ CathayOCR (你在这里)** | 📄 多引擎 GPU 加速古籍 PDF 批处理 OCR | ✅ v1.1.3 |
...
| 下载方式 | 链接 |
|:-------|:-----|
| 📦 **中国移动云盘**（推荐） | [点击下载](https://yun.139.com/shareweb/#/w/i/2wFGpP7Mpxd4l) |
| 📦 **百度网盘**（备用，密码 2026） | [点击下载](https://pan.baidu.com/s/11O7OGe3CKDYp3cUtkpkNaw?pwd=2026) |
...
| 下载方式 | 链接 |
|:-------|:-----|
| 📦 **中国移动云盘**（推荐） | [点击下载](https://yun.139.com/shareweb/#/w/i/2wFGUThxo22kp) |
| 📦 **百度网盘**（备用，密码 2026） | [点击下载](https://pan.baidu.com/s/165w3HUiuPF2DfogWJQh-Hg?pwd=2026) |
...
| 下载方式 | 链接 |
|:-------|:-----|
| 📦 **百度网盘**（密码 2026） | [正在上传](https://pan.baidu.com/s/1B7sWYaQ-c3H3IQKl4UYWMw?pwd=2026) |
