...
> ⚠️ **如果你已经下载了 v1.0.0 版本并发现以下问题，请一定更新到 v1.1.0：**
>
> 🐛 **PDF 识字不全/缺字** — 中文、日文、韩文等字符在导出 PDF 中"消失"了？已修复 ✅
> 🐛 **双击启动闪退/打不开** — 点开后一闪就关闭？已修复 ✅
>
> ⬇️ [点击这里直接下载 v1.1.0](#-安装包下载)（保留旧版本下载链接，放心下载）
...
|:---:|:-----:|:----:|:----:|:--------|:----:|
| **Lite 轻量版** | v1.1.0 ⭐ | .zip | ~640 MB | 🔧 bug 修复版 | [GitHub Release](https://github.com/zzhjim02/CathayOCR/releases/tag/v1.1.0) ⭐ / [百度网盘](https://pan.baidu.com/s/1gOnx5RE21N_lfLryxtKsxw?pwd=2026)（`2026`） |
| **Pro 专业版** | v1.1.0 | .zip | ~5.8 GB | 🔧 bug 修复版 | [百度网盘](https://pan.baidu.com/s/1EQ_GJjYNmoDWJljWZ3y3pw?pwd=2026)（`2026`） |
